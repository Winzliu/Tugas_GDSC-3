...
require 'koneksi.php';
$id = $_GET['id'];
$namaUser = query("SELECT * FROM mahasiswa WHERE id = $id")[0];
...
<body style="font-family: 'Noto serif', serif">
  ...
  <div class="d-flex bg-dark bg-opacity-50 position-absolute top-0 bottom-0 start-0 end-0">
    <div class="card m-auto" style="width: 32rem;height: 18rem;">
      <div class="card-body">
        <h2 class="card-title text-center">Hapus Mahasiwa</h2>
        <hr>
        <h4 class="card-subtitle my-5 text-center">Yakin Ingin Menghapus Mahasiswa <?= $namaUser['nama'] ?> ?
        </h4>
